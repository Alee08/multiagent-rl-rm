...
| `RMaxRM`    | Model-based, RM-aware        | R-Max on the product space \(S X Q\): uses the Reward Machine to augment the MDP state but does **not** factorise environment and automaton dynamics; serves as a RM-aware model-based baseline.                                                                                                                                               |
